...
function App() {
  ...
  const addValue = ()=>{
    ...
    // setCounter(counter+1)
    setCounter(counter=>counter+1) //to separately update them , and not in batches , we use this method where setcounter takes a call back func and then updates the counter
